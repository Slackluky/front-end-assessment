...
<template>
    <div
        class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 px-3 py-2"
    >
        ...
        <div class="flex flex-col items-center pb-10">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400">Cosmetics</span>
